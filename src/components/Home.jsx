...
function Home() {
	...
	return (
        ...
        <button onClick={() => dispatch(decrement())}>Decrement</button> */}
				<p className="absolute top-60 left-1/2 transform -translate-x-1/2">
					Letters Delivered:{' '}
					{loading ? 'Loading...' : localizedInteger()}
				</p>
			</div>
			<div className='h-full w-full mt-2'>
				<h1 className='m-8 -mt-20 mb-10 udnerline'>「Saint Nicholas' Webpage」</h1>
				<div className=''>
				...
				<h3 className='indent text-3xl pl-96 mb-8' > — Saint
					Nicholas</h3>
				</div>
			...
			<div className="pt-40 flex items-center justify-center flex-col absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-1/4 text-3xl">
				<h2><b><i>Anyway... </i></b>Would you like to...</h2>
				<ul className="flex flex-row justify-around flex-nowrap p-6">
					<li className="px-4">
<a href="/letter" className="py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-700 transition duration-300">
  Send Letter
</a>
					</li>
					<li className="px-4">
<a href="/tracker" className="py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-green-700 transition duration-300">
  Track Santa
</a>
					</li>
				</ul>
